 ...
 function SuccessfullSurcharge () {
    ...
    return(
        ...
        <div className="flex flex-col justify-items-center items-center py-2 w-1/2">
            <h2 className="text-sky-500 text-xl">RECARGO CREADO CON EXITO</h2>
            ...
            <button
                    ...
                    type="submit">VER RECARGOS</button>
            </Link>
        </div>
        </section>
        </>
...
export default SuccessfullSurcharge;
