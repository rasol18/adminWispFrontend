...
const filteredFormData = Object.keys(formDataCopy)
  ...
  .reduce((obj, key) => {
    ...
    return <>
        ...
        <h2 className="text-sky-500 text-lg">Agregar nuevo recargo</h2>
        ...
        <div className="mt-2 px-2 w-3/4 min-w-64">
                    <label for='name'>Nombre del recargo</label>        
                    <input 
                        className="w-full relative outline-none border rounded-md p-2 focus:shadow-lg"
                        type="text" name='name' value={formData.name} onChange={handleChange} placeholder="Mora"/>
                </div>
            <div className="mt-2 px-2 w-3/4 min-w-64">
                <label htmlFor="billingText">Texto de Facturación</label>
                <input onChange={handleChange} className="w-full relative outline-none border rounded-md p-2 focus:shadow-lg" type="text" name="billingText" value={formData.billingText} placeholder="Recargo por pago demorado"/>
            </div>
            <div className="mt-2 px-2 w-3/4 min-w-64">
                <label htmlFor="price">Precio del recargo</label>
                <div  className="w-full flex relative outline-none border rounded-md hover:shadow-lg">
                    <div className="pt-2">
                        <DolarIcon></DolarIcon>
                    </div>
                    <input onChange={handleChange} className="p-2 relative outline-none w-full " type="number" name="price" value={formData.price} placeholder="1.500"/>
                </div>
                </div> 
                <div className="mt-2 px-2 w-3/4 min-w-64">
                    ...
                    <input 
                        className="w-full relative outline-none border rounded-md p-2 focus:shadow-lg"
                        type="text" name='description' value={formData.description} onChange={handleChange} placeholder="Recargo por pago fuera de termino."/>
                </div>
